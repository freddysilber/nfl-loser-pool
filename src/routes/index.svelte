<script lang="ts">
	...
	// This is a link we need to update on a per season basis
...
<section>
	<h1 class="text-h1 graduate-text">NFL Loser Pool!</h1>
	<Button text class="graduate-text" on:click={goToSchedule}>Schedule</Button>
</section>
